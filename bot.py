    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Channel", url="https://t.me/Warrior_Units")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Bots Channel", url="https://t.me/WarriorUnitsBots"),
                        InlineKeyboardButton(" Support Group", url="https://t.me/WarriorUnits")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Admin](https://t.me/OO7Jatji)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://f.technicalatg.in/t42IVBPqd")
                    ],
                    [
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Main Channel", url="https://t.me/Warrior_Units")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs"),
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Admin](https://t.me/OO7Jatji).",
                        disable_web_page_preview=True
                    )
                    return
